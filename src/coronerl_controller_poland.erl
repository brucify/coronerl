...
-define(POPULATION,
  ...
  , {<<"Lubuskie">>, 1013031}
  , {<<"Mazowieckie">>, 5411446}
  , {<<77,97,197,130,111,112,111,108,115,107,105,101>>, 3404863}  % <<"Małopolskie">>
  , {<<"Opolskie">>, 984345}
  , {<<"Podkarpackie">>, 2127462}
  , {<<"Podlaskie">>, 1179430}
  , {<<"Pomorskie">>, 2337769}
...
-define(LAND_AREA,
  [ {<<68,111,108,110,111,197,155,108,196,133,115,107,105,101>>, 	19947} % <<"Dolnośląskie">>
  , {<<"Kujawsko-pomorskie">>, 	17971}
  , {<<"Lubelskie">>, 	25123}
  , {<<"Lubuskie">>, 	13988}
  , {<<"Mazowieckie">>, 	35559}
  , {<<77,97,197,130,111,112,111,108,115,107,105,101>>, 	15183} % <<"Małopolskie">>
  , {<<"Opolskie">>, 	9412}
  , {<<"Podkarpackie">>, 	17846}
  , {<<"Podlaskie">>, 	20187}
  , {<<"Pomorskie">>, 	18323}
  , {<<87,97,114,109,105,197,132,115,107,111,45,77,97,122,117,
    114,115,107,105,101>>, 	24173}
  , {<<"Wielkopolskie">>, 	29826}
  , {<<"Zachodniopomorskie">>, 	22905}
  , {<<197,129,195,179,100,122,107,105,101>>, 	18219} % <<"Łódzkie">>
  , {<<197,154,108,196,133,115,107,105,101>>, 	12333} % <<"Śląskie">>
  , {<<197,154,119,105,196,153,116,111,107,114,122,121,115,
    107,105,101>>, 	11710} % <<"Świętokrzyskie">>
  ]
).
...
province(Province, Is, Ds, Rs) ->
  ...
  #{ name            => Province
   ...
   , land_area       => proplists:get_value(Province, ?LAND_AREA, 0)
   }.
